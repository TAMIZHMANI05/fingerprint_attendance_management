...
const TeacherDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const enrolledCount = studentsRes.data.students.filter(s => s.fingerprintId).length;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-green-600 mt-1">
                {stats.totalStudents > 0 ? ((stats.enrolledStudents / stats.totalStudents) * 100).toFixed(0) : 0}% enrolled
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {todayAttendance?.fullyPresent || 0} / {todayAttendance?.totalStudents || 0} present
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-600">
                {todayAttendance ? todayAttendance.totalStudents - todayAttendance.fullyPresent : 0}
              </p>
